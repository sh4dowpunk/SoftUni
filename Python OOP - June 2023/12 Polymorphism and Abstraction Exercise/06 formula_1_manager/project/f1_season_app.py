...
class F1SeasonApp:
    ...
    def register_team_for_season(self, team_name, budget: int):
    ...
    def get_race_results(self, race_name, red_bull_pos: int, mercedes_pos: int):
    ...
    def new_race_results(self, race_name, red_bull_pos: int, mercedes_pos: int):
