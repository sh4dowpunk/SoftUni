...
class StudentTests(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # self.student.courses = {"Python": ["Conditional Statements", "For Loop", "While Loop"]}
        # self.assertEqual(self.student.courses, {"Python": ["Conditional Statements", "For Loop", "While Loop"]})
    ...
    def test_add_notes_when_course_existing(self):
        self.student.courses = {"MathForDevs": []}
        notes_for_add = self.student.add_notes("MathForDevs", ["Calculus", "Statistics", "High School Mat"])
    ...
    def test_leave_courses_when_course_ot_existing(self):
        with self.assertRaises(Exception) as context:
